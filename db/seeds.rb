...
category1.save()
category2 = Category.new({'name' => 'Food', 'image' => 'fake/image/path'})
category2.save()
category3 = Category.new({'name' => 'Nights Out', 'image' => 'fake/image/path'})
category3.save()
category4 = Category.new({'name' => 'Bills', 'image' => 'fake/image/path'})
category4.save()
